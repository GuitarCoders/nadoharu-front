  ...
  return (
    <ReactAlertDialog.Root open={visible}>
      <ReactAlertDialog.Portal>
        <ReactAlertDialog.Overlay className="data-[state=open]:animate-overlayShow bg-black bg-opacity-50 fixed inset-0 z-30" />
            ...
            {extraBtnText ? (
              <ReactAlertDialog.Action asChild>
                <button
                  ...
                  className={`h-10 items-center justify-center rounded-md px-4 font-medium outline-none ${
                    extraBtnColor
